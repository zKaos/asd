...
public class MainActivity extends ListActivity/*AppCompatActivity*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gv=(GridView)findViewById(R.id.gw);
    ...
    void beginListenForData() {
        try {
            ...
            final byte [] mdata=new byte[1000];
            final byte[] x = new byte[1000];
            stopWorker = false;
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                ...
                                                if(sGelenVeri.charAt(0)=='0') {
                                                   sGelenVeri = sGelenVeri.substring(1, 9);

                                                   // MtxtVwState.setText(sGelenVeri);
                                                   // MtxtVwState.setText(motor);
                                                    // int tut=Integer.parseInt(sGelenVeri);
                                                    //motor=Integer.parseInt(sGelenVeri);
